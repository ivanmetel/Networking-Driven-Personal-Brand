...
Этот документ содержит руководство по работе с Antigravity в контексте SRT-метода и интеграции с First Principles Framework (FPF).

## Архитектура контекста

При каждом запросе Antigravity получает:
1. **Системный промпт** — базовые инструкции
2. **ANTIGRAVITY.md** — этот файл с терминологией и принципами
...
При создании или редактировании **любого** документа в хранилище, Antigravity **обязан** сначала прочитать:
...
### Механизм работы Antigravity с 0.Management/
...
При запросе на создание документа Antigravity должен автоматически выполнить:
...
```yaml
---
author: Antigravity              # ОБЯЗАТЕЛЬНО. Ты — автор этого документа.
...
|--------|-------|-------------|
| AI agent 3.5 | 200K токенов | Не вмещается целиком |
...
- [ANTIGRAVITY.md](ANTIGRAVITY.md) — инструкции для Antigravity
