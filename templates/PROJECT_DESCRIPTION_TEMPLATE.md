...
>
> **Важно:** Для правильного определения трёх систем (целевой, надсистемы, создателя) изучите [Принципы определения систем](../content/0.Management/0.1.%20Логика%20хранилища%20и%20знаний/system-identification.md).
...
3. **Запустите экспертизу** с AI agent Code:
...
*Шаблон версии 1.1 | SRT Template | 2026-01-08*
