...
Этот документ содержит руководство по работе с Cline в контексте SRT-метода и интеграции с First Principles Framework (FPF).

## Архитектура контекста

При каждом запросе Cline получает:
1. **Системный промпт** — базовые инструкции
2. **CLINE.md** (~2K токенов) — этот файл с терминологией и принципами
...
При создании или редактировании **любого** документа в хранилище, Cline **обязан** сначала прочитать:
...
### Механизм работы Cline с 0.Management/
...
При запросе на создание документа Cline должен автоматически выполнить:
...
created: 2026-01-07
updated: 2026-01-07
author: Cline                    # ОБЯЗАТЕЛЬНОЕ ПОЛЕ для всех документов
