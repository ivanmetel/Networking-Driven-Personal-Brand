...
Этот документ содержит руководство для **любого AI agent** (Cline, Antigravity, Claude Code и других) по работе с хранилищем знаний в контексте SRT-метода и интеграции с First Principles Framework (FPF).
...
2. **AI_AGENT.md** (~2K токенов) — этот файл с терминологией и принципами
...
```yaml
---
author: AI agent                 # ОБЯЗАТЕЛЬНОЕ ПОЛЕ для всех документов. Ты — AI agent.
...
> **Для AI agent:** Всегда указывай `author: AI agent` в frontmatter создаваемых документов. Ты — автор.
