...
## Как мы организуем знания — SRD-метод
...
![Организация знаний с помощью SRD-метода](assets/srd-method.png)
...
| **F0** | Метасистема | Управление хранилищем + мосты |
...
**Ссылки:**
- [README.md](../../README.md)
- [Глоссарий](../0.1.%200Knowledge-Base-Logic/glossary.md)
- [Модель семейств](../0.1.%200Knowledge-Base-Logic"/document-families.md)
