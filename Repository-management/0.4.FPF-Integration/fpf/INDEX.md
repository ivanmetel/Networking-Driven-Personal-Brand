...
**Описание:** Организация через матрицу Систем-Ролей (3×3)

**Обоснование:** SRR обеспечивает структурированное, но гибкое размещение знаний. Каждый документ имеет чёткое место.
...
Принципы FPF применяются во всех ячейках матрицы SRR:
